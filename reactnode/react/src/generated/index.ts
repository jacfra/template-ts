...
export type GetDemoQuery = {
  __typename?: "Query";
  demo: Array<{ __typename?: "DemoEntity"; id: string; value: string }>;
};
...
export const GetDemoDocument = `
  ...
  demo {
    ...
    `;
export const useGetDemoQuery = <TData = GetDemoQuery, TError = unknown>(
  client: GraphQLClient,
  ...
  useQuery<GetDemoQuery, TError, TData>(
    ...
    fetcher<GetDemoQuery, GetDemoQueryVariables>(
      client,
      GetDemoDocument,
      variables,
      headers
